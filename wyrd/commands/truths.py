...
from wyrd.engine.truths import get_ordered_categories
from wyrd.models.truths import ChosenTruth, TruthCategory, TruthOption
from wyrd.ui import display
from wyrd.ui.theme import BORDER_REFERENCE, COOP_TRUTH, ORACLE_RESULT
...
def run_truths_wizard(
    ...
    *,
    ...
    from wyrd.commands.wizard_oracle import make_oracle_key_bindings
...
def _truth_prompt(
    ...
    """
    from wyrd.commands.wizard_oracle import check_oracle_prefix
...
def _handle_truth_propose(state: GameState, args: list[str]) -> None:
    ...
    from wyrd.models.campaign import TruthProposal
    ...
    from wyrd.state.campaign import save_campaign
