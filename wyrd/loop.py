...
from wyrd.commands.campaign import handle_campaign
...
from wyrd.commands.debility import handle_debility
from wyrd.commands.guide import handle_guide
from wyrd.commands.guided_mode import advance_phase, stop_guided_mode
from wyrd.commands.interpret import handle_accept, handle_interpret
from wyrd.commands.move import handle_move
from wyrd.commands.oracle import handle_oracle
from wyrd.commands.registry import COMMAND_HELP, parse_command
from wyrd.commands.roll import handle_roll
...
from wyrd.commands.truths import handle_truths
from wyrd.commands.vow import handle_fulfill, handle_progress, handle_vow
...
from wyrd.engine.oracles import OracleTable, load_oracles
from wyrd.engine.truths import TruthCategory, load_truth_categories
...
from wyrd.state.save import autosave
from wyrd.sync import FileLogAdapter, LocalAdapter, SyncPort
...
def _dispatch_command(state: GameState, cmd_name: str, args: list[str], flags: set[str]) -> None:
    ...
    match cmd_name:
        ...
        case "forsake":
            from wyrd.commands.move import _handle_forsake_vow
...
def run_session(
    ...
    history_path = config.adventures_dir / ".wyrd_history"
    ...
    while state.running:
        try:
            ...
            if state.guided_mode:
                from wyrd.commands.guided_mode import get_guided_prompt_html
...
def _autosave_state(state: GameState) -> None:
    ...
    from wyrd.config import config
    from wyrd.state.campaign import player_save_path
    from wyrd.state.truths_md import write_adventure_truths
