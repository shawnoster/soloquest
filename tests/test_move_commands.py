...
from wyrd.commands.move import (
...
from wyrd.engine.moves import OutcomeTier
...
class TestChooseStat:
    ...
    @patch("wyrd.commands.move.Prompt.ask")
    @patch("wyrd.commands.move.display.info")
    ...
    @patch("wyrd.commands.move.Prompt.ask")
    @patch("wyrd.commands.move.display.info")
    @patch("wyrd.commands.move.display.error")
...
class TestHandleMove:
    ...
    @patch("wyrd.commands.move.display.console")
    ...
    @patch("wyrd.commands.move.display.warn")
    ...
    @patch("wyrd.commands.move.display.console.print")
...
class TestHandleMoveOracleRoll:
    ...
    @patch("wyrd.commands.move.roll_oracle")
    @patch("wyrd.commands.move.Prompt.ask", return_value="3")
    @patch("wyrd.commands.move.display.console")
    @patch("wyrd.commands.move.display.info")
...
class TestHandleMoveProgressRoll:
    ...
    @patch("wyrd.commands.move.roll_challenge_dice")
    @patch("wyrd.commands.move.Prompt.ask")
    @patch("wyrd.commands.move.display.move_result_panel")
...
class TestHandleMoveMixedDiceMode:
    ...
    def setup_method(self):
        ...
        from wyrd.engine.dice import MixedDice

        self.state.dice = MixedDice()

    @patch("wyrd.commands.move.roll_action_dice")
    @patch("wyrd.commands.move.Prompt.ask")
    @patch("wyrd.commands.move.Confirm.ask")
    @patch("wyrd.commands.move.display.move_result_panel")
